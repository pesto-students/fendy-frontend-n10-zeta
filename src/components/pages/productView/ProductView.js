...
const image = [testImage,testImage,testImage];
const ProductView = () => {
    return(
    <>
    <Header/>
    ...
    <section>
        <div className={styles.leftSection}>
            <ProductImage images={image} selectedImage={1}/>
        </div>
        <div className={styles.rightSection}>
            <ProductDetails productName="Perfect Business Outfit for Men"/>
        </div>
    </section>
    <section>
